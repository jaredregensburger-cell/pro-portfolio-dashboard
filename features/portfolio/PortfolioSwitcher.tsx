...
import { useSimulationStore, useModalStore } from '@/store'
    ...
    <div ref={containerRef} className="relative px-2 pb-2">
      ...
      >
        ...
        <div className="flex-1 min-w-0 text-left">
          <p className="text-data-sm font-medium text-ink truncate leading-tight">{active.name}</p>
          <p className="text-data-xs text-ink-faint">{active.currency}</p>
        </div>
          ...
          {portfolios.map((p) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={cn(
                    'flex-1 min-w-0 truncate text-data-sm font-medium',
